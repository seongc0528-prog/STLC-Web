  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`absolute inset-y-0 right-0 flex w-[min(21rem,86vw)] flex-col border-l-4 border-[#c8a04a] bg-[#f6f3ea] shadow-[-18px_0_40px_rgba(15,36,18,0.28)] transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] ${
          ...
          aria-label="전체 메뉴"
        >
          <div className="flex items-center justify-between border-b border-[#e0d7bf] bg-[#efe9d8] px-5 py-4">
          ...
          <div className="flex items-center justify-between gap-3 border-t border-[#e0d7bf] bg-white px-5 py-4 text-sm">
            <NotificationOptIn />
            <AuthButtons />
          </div>
        </div>
